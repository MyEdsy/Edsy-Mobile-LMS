            ...
            children: List<Widget>.generate(
              ...
              (int index) {
                ...
                return _tugasSiswaCard(
                      ...
                      onTap: () {
                        Navigator.pushNamed(context, DetailTugas.routeName,
                            arguments: {
                              ...
                              "idkelompokkls":
                                  MenuTugas.dataMapelPerIndex['idkelompokkls'],
                              "Namamapel":
                                  MenuTugas.dataMapelPerIndex['Namamapel'],
                              "KelompokKelas":
                                  MenuTugas.dataMapelPerIndex['KelompokKelas'],
                              "NamaKelompokKelas": MenuTugas
                                  .dataMapelPerIndex['NamaKelompokKelas'],
                              ...
                              "link_sumberlain": dataTugas[index]
                                  ['link_sumberlain'],
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, UpdateTugas.routeName,
                            arguments: {
                              "NIP": MenuTugas.dataMapelPerIndex['NIP'],
                              "idMapel": MenuTugas.dataMapelPerIndex['idMapel'],
                              "idkelompokkls":
