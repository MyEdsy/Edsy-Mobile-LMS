      ...
      children: List<Widget>.generate(
        dataTugas.length,
          ...
          return _tugasSiswaCard(
                ...
                onTap: () {
                  Navigator.pushNamed(context, DetailQuizSiswa.routeName,
                      arguments: {
                        ...
                        "KelompokKelas" : MenuQuizSiswa.dataMapelPerIndex['KelompokKelas'],
                        "NamaKelompokKelas" : MenuQuizSiswa.dataMapelPerIndex['NamaKelompokKelas'],
              ...
              GestureDetector(
                onTap: () {
                  // Navigator.pushNamed(context, UpdateQuiz.routeName,
                  //     arguments: {
                  //       "NIP": MenuQuizSiswa.dataMapelPerIndex['NIP'],
                  //       "idMapel": MenuQuiz.dataMapelPerIndex['idMapel'],
                  //       "idkelompokkls":
                  //       MenuQuiz.dataMapelPerIndex['idkelompokkls'],
                  //       "Namamapel" : MenuQuiz.dataMapelPerIndex['Namamapel'],
                  //       "KelompokKelas" : MenuQuiz.dataMapelPerIndex['KelompokKelas'],
                  //       "NamaKelompokKelas" : MenuQuiz.dataMapelPerIndex['NamaKelompokKelas'],
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${getTugas}Quiz/${MenuQuizSiswa.dataMapelPerIndex['Nip']}/${MenuQuizSiswa.dataMapelPerIndex['idMapel']}/${MenuQuizSiswa.dataMapelPerIndex['idkelompokkls']}/${dataTahunAjaran['tahunakademik']}/${dataTahunAjaran['semester']}",
          headers: headers);
