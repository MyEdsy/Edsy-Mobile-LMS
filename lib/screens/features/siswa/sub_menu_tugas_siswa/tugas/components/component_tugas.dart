                      ...
                      onTap: () {
                        Navigator.pushNamed(context, DetailTugasSiswa.routeName,
                            arguments: {
                              ...
                              "KelompokKelas" : MenuTugasSiswa.dataMapelPerIndex['KelompokKelas'],
                              "NamaKelompokKelas" : MenuTugasSiswa.dataMapelPerIndex['NamaKelompokKelas'],
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${getTugas}Tugas/${MenuTugasSiswa.dataMapelPerIndex['Nip']}/${MenuTugasSiswa.dataMapelPerIndex['idMapel']}/${MenuTugasSiswa.dataMapelPerIndex['idkelompokkls']}/${dataTahunAjaran['tahunakademik']}/${dataTahunAjaran['semester']}",
          headers: headers);
